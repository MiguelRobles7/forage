<script>
import HomeViewNavLoggedIn from '../components/navbars/HomeViewNavLoggedIn.vue'
...
<template>
  <main>
    <div class="gradient-bg">
      <HomeViewNavLoggedIn name="Johndayll Arizala" image="/public/profile/pfps/1.png"></HomeViewNavLoggedIn>
